...
- [Existing Database Design](#existing-database-design)
- [Updated Database Design](#updated-database-design)
- [User Stories](#user-stories)

## Overview
[Adopt Don't Shop](https://github.com/aedanjames/adopt_dont_shop) is first week-long solo project of Module 2 at Turing School Of Software and Engineering back-end engineering program.    

In this project, I built upon the code in a preexisting repository to create a Pet Adoption Platform. Users will be able to apply to adopt pets, and Admins will be able to approve or reject applications and see statistics for the Shelters, Pets, and Applications in the system.    
...
* Use `within` blocks in tests in order to test order
* Track user stories using GitHub Projects
* Deploy an application to Heroku
* Complete 100% of user stories 

## Configuration 
|             |               |               |               |
|   :----:    |    :----:     |    :----:     |    :----:     |
| Ruby 2.7.x  | SQL           | SimpleCov     |  Faker        |
| Rails       | ActiveRecord  | Capybara      | VSCode        |
| RSpec       | HTML5         | ShouldaMatcher| Launchy       |
| Pry         | Github        | Git           | Orderly       |

## How to Use 
**Visit** [This url](https://whispering-forest-95258.herokuapp.com).     
**Visit** [admin shelter functionality](https://whispering-forest-95258.herokuapp.com/admin/shelters)

## Contributors 
👤 **Turing School of Software and Engineering Staff** (legacy code)
- [GitHub](https://github.com/turingschool-examples/adopt_dont_shop)
...
![adopt-schema.png](https://i.postimg.cc/PqhdqSvC/adopt-schema.png)
