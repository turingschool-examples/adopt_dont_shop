Rails.application.routes.draw do
  ...
  get '/appliactions', to: 'appliactions#index'
  get '/appliactions/new', to: 'appliactions#new'
  get '/appliactions/:id', to: 'appliactions#show'
  post '/appliactions', to: 'appliactions#create'
  get '/appliactions/:id/edit', to: 'appliactions#edit'
  patch '/appliactions/:id', to: 'appliactions#update'
  delete '/appliactions/:id', to: 'appliactions#destroy'
end
