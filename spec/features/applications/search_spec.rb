...
RSpec.describe 'search' do
  ...
  let!(:application) { Application.create!(name: 'Joe', street_address: "123 street lane", city: "denver", state: "co", zip_code: "12345", description: "Waiting for user description.", status: "In Progress" ) }
