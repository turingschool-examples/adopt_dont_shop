...
RSpec.describe 'the application show' do
  it "shows the applicant and all it's attributes" do
    ...
    application = scooby.applications.create!(status: "In Progress", name: "Murmuring Savannah", street: 'Main',city: 'Leadville', state: 'CO', zip: 11111, status: "In Progress", description: "I'm a real cool cat")
