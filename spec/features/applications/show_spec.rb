...
RSpec.describe 'Application Show' do
  before(:each) do
    ...
    @app_1 = Application.create!(first: "Joe", last: "Hilby", street: "1234 N A St", city: "Any Town", state: "AnyState", zip: "12345", status: "In Progress")
    @app_2 = Application.create!(first: "Joe", last: "Hilby", street: "1234 N A St", city: "Any Town", state: "AnyState", zip: "12345", status: "In Progress")
