...
RSpec.describe "Application show page" do
  before :each do
    ...
    @application = Application.create(name: 'Jamie', street: '123 S Pearl St', state: "Colorado", city: "Denver", zip_code: "80212", description: "Really loves dogs")
  ...
  it 'displays the applicant name, full address, description, name of all pets applied for and application status' do
    ...
    expect(page).to have_content(@application.pets.first.application_status)
  end
end
