...
RSpec.describe 'the veterinary offices veterinarians index' do
  ...
  xit 'lists all the veterinarians associated with the office, with their attributes' do
  ...
  xit 'displays a link to create a new veterinarian' do
    visit "/veterinary_offices/#{@vet_office_1.id}/veterinarians"
  ...
  xit 'displays a form for a number value' do
    visit "/veterinary_offices/#{@vet_office_1.id}/veterinarians"
  ...
  xit 'only displays records above the given return value' do
    visit "/veterinary_offices/#{@vet_office_1.id}/veterinarians"
