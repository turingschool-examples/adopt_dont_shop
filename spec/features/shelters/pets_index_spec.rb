...
RSpec.describe 'the shelters pets index' do
  before(:each) do
    ...
    @shelter_2 = Shelter.create!(foster_program: false, name: "Island Lake Animal Hospital", city: "Denver", rank: 8, street_address: "789 River Road", state: "CO", zip_code: 11556)
