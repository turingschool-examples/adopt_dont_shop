...
RSpec.describe 'the shelters index' do
  before(:each) do
    ...
    @shelter_1.pets.find_or_create_by!(name: 'Mr. Pirate', breed: 'tuxedo shorthair', age: 5, adoptable: true)
    @shelter_1.pets.find_or_create_by!(name: 'Clawdia', breed: 'shorthair', age: 3, adoptable: true)
    @shelter_3.pets.find_or_create_by!(name: 'Lucille Bald', breed: 'sphynx', age: 8, adoptable: true)
  end
