...
RSpec.describe 'Shelters Index' do
  ...
  describe 'When I visit /shelters' do
    describe 'Then I see' do
      ...
      it 'listsed by most recently created first' do
        visit "/shelters"
      ...
      it 'a link to sort shelters by the number of pets they have' do
        visit '/shelters'
      ...
      it 'a link to update each shelter' do
        visit "/shelters"
