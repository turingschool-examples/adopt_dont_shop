...
RSpec.describe 'admin shelter index page' do
  ...
  it 'has a section that lists only shelters with pending applications' do
    ...
    pet_2 = Pet.create!(adoptable: false, age: 3, breed: "GSP", name: "Newton", shelter_id: @shelter_2.id)
    pet_3 = Pet.create!(adoptable: false, age: 13, breed: "German Shepard", name: "Molly", shelter_id: @shelter_3.id)
