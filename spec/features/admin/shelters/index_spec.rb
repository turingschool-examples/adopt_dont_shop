...
RSpec.describe 'Admin/shelters#index' do
  describe 'when I visit the admin shelters index page' do
    ...
    @pet_application_1 = PetApplication.create!(application_id: @app_1.id, pet_id: @pet_1.id, status: 'Pending')
    @pet_application_2 = PetApplication.create!(application_id: @app_2.id, pet_id: @pet_2.id, status: 'Pending')
    @pet_application_3 = PetApplication.create!(application_id: @app_2.id, pet_id: @pet_1.id, status: 'Rejected')
    end
