...
RSpec.describe 'admin shelters index page' do
  ...
  let!(:pet_1) { shelter.pets.create(name: 'Mr. Pirate', breed: 'tuxedo shorthair', age: 5, adoptable: true) }
  ...
  let!(:app_2) { pet_2.applications.create(name: "Violet", street_address: "678 Main st", city: "Denver", state: "CO", zip_code: "83302", application_status: "Pending") }
  let!(:app_3) { pet_3.applications.create(name: "Hannah", street_address: "MLK blvd", city: "Denver", state: "CO", zip_code: "83402", application_status: "In Progress") }
