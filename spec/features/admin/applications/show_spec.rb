...
RSpec.describe 'admin application show', type: :feature do
  ...
  let!(:pet_3) { shelter_1.pets.create!(name: 'Hank', breed: 'longhair', age: 5, adoptable: true) }
  ...
  let!(:application_3) { Application.create!(name: "Steve", street_address: "123 Main St", city: "Denver", state: "CO", zip_code: "80202", description: "I love cats", status: "In Progress") }
  ...
  let!(:application_pets_3) { ApplicationPet.create!(application_id: application_1.id, pet_id: pet_3.id) }
  let!(:application_pets_4) { ApplicationPet.create!(application_id: application_3.id, pet_id: pet_1.id) }
