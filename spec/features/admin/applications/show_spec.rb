...
RSpec.describe 'admin shelters index' do
  before(:each) do
    ...
    @pet_1 = @application_2.pets.create!(name: 'Scrappy', age: 1, breed: 'Great Dane', adoptable: true, shelter_id: @shelter_1.id)
    @pet_2 = @application_2.pets.create!(name: 'Spot', age: 3, breed: 'Dalmation', adoptable: true, shelter_id: @shelter_3.id)
