...
RSpec.describe Application, type: :model do
  ...
  describe 'instance methods' do
    it 'displays address' do
      @application = Application.create!(name: 'Joe', street_address: "123 street lane", city: "denver", state: "co", zip_code: "80218", description: "I like dogs", status: "Pending" )
    ...
    it 'no_description?' do
      @application_1 = Application.create!(name: 'Joe', street_address: "123 street lane", city: "denver", state: "co", zip_code: "80218", description: "I like dogs", status: "Pending" )
      @application_2 = Application.create!(name: 'Bob', street_address: "123 street lane", city: "denver", state: "co", zip_code: "80218", description: "Waiting for user description.", status: "In Progress" )
