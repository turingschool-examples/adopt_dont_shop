...
RSpec.describe VeterinaryOffice, type: :model do
  describe 'relationships' do
    xit { should have_many(:veterinarians) }
  end

  describe 'validations' do
    xit { should validate_presence_of(:name) }
    xit { should validate_presence_of(:max_patient_capacity) }
    xit { should validate_numericality_of(:max_patient_capacity) }
  end
  ...
  describe 'class methods' do
    ...
    describe '#order_by_recently_created' do
      xit 'orders the offices by those most recently created first' do
    ...
    describe '#order_by_number_of_vets' do
      xit 'orders the offices by those with most veterinarians to least' do
  ...
  describe 'instance methods' do
    describe '.vet_count' do
      xit 'returns the number of veterinarians associated with the given office' do
