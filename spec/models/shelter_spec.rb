...
RSpec.describe Shelter, type: :model do
  ...
  before(:each) do
    ...
    @application3 = Applicant.create!(name: 'Bob', street_address: '123 Builders Lane', city: 'Las Vegas', state: 'NV', zip_code: 99298, home_description: 'I just lost my dog and looking for another', status: 'in progress')
