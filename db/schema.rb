...
ActiveRecord::Schema.define(version: 2021_12_12_041521) do
  ...
  create_table "pet_applications", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["application_form_id"], name: "index_pet_applications_on_application_form_id"
  ...
  add_foreign_key "pet_applications", "application_forms"
