...
ActiveRecord::Schema.define(version: 2023_04_02_193227) do
  ...
  create_table "shelter_veterinarians", force: :cascade do |t|
    t.bigint "veterinarian_id"
    t.bigint "shelter_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["shelter_id"], name: "index_shelter_veterinarians_on_shelter_id"
    t.index ["veterinarian_id"], name: "index_shelter_veterinarians_on_veterinarian_id"
  end
  ...
  add_foreign_key "shelter_veterinarians", "shelters"
  add_foreign_key "shelter_veterinarians", "veterinarians"
