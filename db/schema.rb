...
ActiveRecord::Schema.define(version: 2022_10_20_203727) do
  ...
  create_table "pet_applicants", force: :cascade do |t|
    ...
    t.index ["application_id"], name: "index_pet_applicants_on_application_id"
  ...
  add_foreign_key "pet_applicants", "applications"
