...
# pet_3.applying_applications.create(full_name: 'Yo Lo', street_address: '34573 Board Rd.',
...
# pet_4.applying_applications.create(full_name: 'Kristy Teal', street_address: '47674 Bolas St.',
