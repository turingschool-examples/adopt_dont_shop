...
application_2 = Application.create!(applicant_name: "Ben Spiegel", street_address: "134 Windy meadows", city: "Boulder", state: "CO", zip_code: "80023", application_status: "In Progress")
...
pet_1 = application_1.pets.create!(adoptable: "true", age: "5", breed: "Lab", name: "Bear", shelter_id: "#{shelter_1.id}")
pet_5 = application_1.pets.create!(adoptable: "true", age: "3", breed: "Terrier", name: "Sparky", shelter_id: "#{shelter_1.id}")
