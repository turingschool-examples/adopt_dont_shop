...
application_1 = Application.create(name: "Steve Rogers", street_address: "990 Logan St", city: "Denver", state: "CO", zip_code: "80203", description: "Lover of dogs and avid poo-picker-upper.", status: "In Progress")
application_2 = Application.create(name: "Bruce Banner", street_address: "16 Bay Oaks Ct", city: "Lake St. Louis", state: "MO", zip_code: "63367", description: "Scientist with anger management issues. In need of emotional support dog", status: "In Progress")
