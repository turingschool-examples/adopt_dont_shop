...
application_1 = Application.create!(name: "Michael Hicks", street_address: "858 S Emerson St", city: "Dever", state: "CO", zipcode: "80211")
application_2 = Application.create!(name: "Suzanne Roth", street_address: "9406 Oakmont Rd", city: "Albuquerque", state: "NM", zipcode: "87111", description: "Best dog mom ever!", status: "Accepted")
application_3 = Application.create!(name: "Ada Hicks", street_address: "4012 Tracy St NE", city: "Albuquerque", state: "NM", zipcode: "87111", description: "I'm actually a dog myself!", status: "Pending")
