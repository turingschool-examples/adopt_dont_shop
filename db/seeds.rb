...
@pet_3 = Pet.create!(name: 'Ann', breed: 'ragdoll', age: 3, adoptable: false, shelter_id: @shelter_1.id)

@application_form_1 = ApplicationForm.create!(name: "Joe Shmoe", street_address: '123 Commerce St', city: "Bridgeton", state: "NJ", zip_code: "08302", description: "I don't know")
