...
@jane_johnson_app = Application.create!(name: 'Jane Johnson', street_address: '2548 Bungalow Ave', city: 'Spokane', state: 'WA', zip_code: 27338, description: 'I like cats. Give me some.', status: 'In Progress')
@roberta_benson_app = Application.create!(name: 'Roberta Benson', street_address: '700 W 18th Ave Apt 101', city: 'Bend', state: 'OR', zip_code: 84585, description: 'I am very responsible and need animal friends because I have no human friends.', status: 'In Progress')
