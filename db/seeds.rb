...
# shelter2 = Shelter.create!(foster_program: 'Racoon Wranglers', name: 'Coon Haven', city: 'Brighton', rank: 2)
# shelter3 = Shelter.create!(foster_program: 'Fluffly Friends', name: 'The Pound', city: 'Denver', rank: 3)
